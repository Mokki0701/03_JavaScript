...
document.querySelector("#btn1").addEventListener("click", ()=>{
    ...
    // -> #text(ul태그) 의 첫 번째 자식 노드 찾기


    // 원하는 위치(index)에 존재하는 자식 노드 찾기
    // (요소.childNodes[index])
    // -> #test의 자식 노동 중
    // 3번째 li 내그를 찾아서 배경색 pink 지정하기
    ...
    list[11].prepend("dk", "아");
    list[11].prepend("Hello"); // 첫 번째 자식(맨 앞) 추가

    // 4. 이전/다음 형제로 추가( befor/after("내용" 또는 노드 또는 요소 ) )
