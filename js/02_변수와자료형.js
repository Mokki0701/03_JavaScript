...
/* 변수에 대입한 값 변경하기 */
number1 = 300; // number1에 300대입(기존 값 10을 덮어쓰기함)
number2 = 400; 
...
// PI = 1.23; // Assignment to constant variable.
console.log("PI : ", PI);
...
console.log(typeof user.id,typeof user.pw,typeof user.userName);
...
console.log(typeof sumFn, sumFn(3,5)); // function, 함수 호출(기능 수행)
...
/* 
    ...
    대입 연산자(=)
    ex) A = B; -> B라는 값을 A변수에 대입 (오른쪽 값을 왼쪽 변수에 대입)
