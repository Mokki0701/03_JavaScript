...
function plusFn(){
    ...
    // -> 데이타 파싱(data parsing) : 데이터의 종류를 바꿈
    ...
    */
    ...
    /* 두 수의 합을 아이디가 "calcResult"인 요소(result 변수) 의
        내부 글자(innerText, HTML 요소내용)으로 대입하기
    */
...
function totalFn(){
    const su1 = Number(num1.value);
    
    const su2 = Number(num2.value);
    const su3 = Number(num3.value);

    sum.innerText = su1 + su2 + su3;
}
